...
form.destroy{position:absolute;right:0;top:0;display:none;}
&:hover form.destroy{display:block;}
form.add{margin:0 auto;}
h2{text-align:center;margin:0;}}
.task{overflow:hidden;border-bottom:dotted 1px #ccc;
padding:0;position:relative;padding:4px 28px;
form.update{position:absolute;bottom:4px;left:0;
